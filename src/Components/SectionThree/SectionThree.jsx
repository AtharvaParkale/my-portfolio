      ...
      <div className="skills-holder">
        ...
        <div className="icon-holder">
          <div className="icon-holder-row">
            ...
            <div className="icon-box">
              <div className="icon-image"><img src={cssicon} alt="css" /></div>
              <span>Css</span>
            </div>
            <div className="icon-box">
              <div className="icon-image"><img src={javascripticon} alt="javascript" /></div>
          ...
          <div className="icon-holder-row">
            <div className="icon-box">
              <div className="icon-image"><img src={reacticon} alt="react" /></div>
              <span>React</span>
            </div>
            <div className="icon-box">
              <div className="icon-image"><img src={nodejsicon} alt="node" /></div>
              <span>NodeJS</span>
            </div>
            <div className="icon-box">
              <div className="icon-image"><img src={expressicon} alt="express" /></div>
              <span>Express</span>
            </div>
          </div>
          ...
          <div className="icon-holder-row">
            <div className="icon-box">
              <div className="icon-image"><img src={mongoicon} alt="mongo" /></div>
              <span>MongoDB</span>
            </div>
            <div className="icon-box">
              <div className="icon-image"><img src={materialuiicon} alt="material" /></div>
              <span>MaterialUI</span>
            </div>
            <div className="icon-box">
              <div className="icon-image"><img src={firebaseicon} alt="firebase" /></div>
              <span>Firebase</span>
            </div>
          </div>
        </div>
